...
export default function Login() {
    ...
    return (
        ...
        <form method="POST" action="#" onSubmit={handleSubmit} className="space-y-6">
            ...
            />
            <label
                className="absolute left-0 -top-3.5 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-800 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-emerald-500 peer-focus:text-sm"
                for="email"
                >Email address</label
            >
            </div>
